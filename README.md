...
Open-source **[Flask Dashboard](https://appseed.us/admin-dashboards/flask/)** generated by `AppSeed` op top of an iconic design. For newcomers, **SB Admin** is one of the best open-source admin dashboard & control panel themes. Built on top of Bootstrap, `SB Admin` provides a range of responsive, reusable, and commonly used components. 
...
```bash
$ git clone https://github.com/app-generator/flask-sb-admin.git
$ cd flask-sb-admin
```
...
---
[SB Admin Flask](https://appseed.us/product/sb-admin/flask/) - Free starter generated by **[App Generator](https://appseed.us/generator/)**.
